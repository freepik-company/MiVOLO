...
from timm.models._helpers import load_state_dict, remap_state_dict # remap_checkpoint
...
def load_checkpoint(
    ...
    if remap:
        state_dict = remap_state_dict(state_dict, model)  #remap_checkpoint(model, state_dict)
    if filter_keys:
